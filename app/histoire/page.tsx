  ...
  return (
    <main className="min-h-screen bg-cover bg-center bg-fixed" style={{ backgroundImage: "url('/back.png')" }}>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-orange-400/10 p-6 rounded-lg border-l-4 border-orange-400">
            ...
            <div className="bg-lime-500/10 p-6 rounded-lg border-l-4 border-lime-500">
            ...
            <div className="bg-teal-400/10 p-6 rounded-lg border-l-4 border-teal-400">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center text-gray-800">Notre parcours</h2>
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            <div className="mb-16 relative">
              <div className="absolute left-1/2 transform -translate-x-1/2 -mt-3 w-7 h-7 rounded-full bg-orange-400 border-4 border-white z-10"></div>
              <div className="relative pl-8 md:w-1/2 md:ml-0 md:mr-auto md:pr-8 md:pl-0 text-right">
                ...
                <p>Fondation de la Congrégation salésienne par Saint Jean Bosco à Turin, Italie.</p>
              </div>
            </div>
            ...
            <div className="mb-16 relative">
              ...
              <div className="relative pl-8 md:w-1/2 md:ml-auto md:mr-0 md:pl-8 md:pr-0">
                ...
                <p>Arrivée des premiers Salésiens au Cameroun et début des activités éducatives.</p>
              </div>
            </div>
            ...
            <div className="mb-16 relative">
              ...
              <div className="relative pl-8 md:w-1/2 md:ml-0 md:mr-auto md:pr-8 md:pl-0 text-right">
                ...
                <p>Ouverture du centre Don Bosco Mimboman pour répondre aux besoins des jeunes défavorisés.</p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative pl-8 md:w-1/2 md:ml-auto md:mr-0 md:pl-8 md:pr-0">
                ...
                <p>Nous continuons à développer nos programmes éducatifs et à étendre notre impact auprès des jeunes.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-orange-400 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/hilf-mit/spenden" className="bg-white text-orange-600 hover:bg-orange-50 px-8 py-3 rounded-md font-medium transition-colors duration-300">
              Faire un don
            </a>
            <a href="/hilf-mit/freiwilligenarbeit" className="bg-orange-600 hover:bg-orange-700 px-8 py-3 rounded-md font-medium transition-colors duration-300">
              Devenir bénévole
            </a>
          </div>
        </div>
